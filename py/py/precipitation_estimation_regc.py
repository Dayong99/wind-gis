...
levels = [0.1, 2.5, 5, 7.5, 10, 12.5, 15, 17.5, 20, 22.5, 25, 27.5, 30, 33.3, 36.6, 39.9, 43.2, 46.5, 50]
...
def getImg(data,valid_range):
    ...
    nanId = np.where(np.isnan(data00))
...
if __name__ == '__main__':
    # inputFile = r"D:\Project\FY4\QPE\REGC\20200527\005336" \
    #    r"\FY4A-_AGRI--_N_REGC_1047E_L2-_QPE-_MULT_NOM_20200527005336_20200527005753_4000M_V0001.NC"
    # out_path = r"D:\Project\FY4\QPE\REGC\20200527\005336\QuickView\Precipitation_proj.png"
