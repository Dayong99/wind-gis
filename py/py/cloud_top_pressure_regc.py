...
def color_mapping(data):
    ...
    m = data.shape[0]
    data00[70:(70 + m), :] = data
    nanId = np.where((data00 > 1100) | np.less(data00[::], 1) | np.isnan(data00))
    data = data00
...
if __name__ == '__main__':
    try:
        ...
        traceback.print_exc()
        print("Failed")
# python cloud_top_pressure.py -54.96 54.96 49.74 159.66 C:\Users\Administrator\Desktop\FY4A-_AGRI--_N_REGC_1047E_L2-_CTP-_MULT_NOM_20200527113836_20200527114253_4000M_V0001.NC C:\Users\Administrator\Desktop\FY4A-_AGRI--_N_REGC_1047E_L2-_CTP-_MULT_NOM_20200527113836_20200527114253_4000M_V0001.PNG 1024
