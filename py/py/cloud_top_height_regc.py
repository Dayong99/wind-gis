...
channel_color = {
    1.0: (24, 0, 255, 255,), 1000.0: (0, 45, 255, 255,), 2000.0: (0, 106, 255, 255,),
    3000.0: (0, 177, 255, 255,), 4000.0: (0, 233, 255, 255,), 5000.0: (0, 255, 198, 255,),
    6000.0: (0, 255, 126, 255,), 7000.0: (0, 255, 55, 255), 8000.0: (20, 255, 0, 255,),
    9000.0: (93, 255, 0, 255,), 10000.0: (131, 255, 0, 255,), 11000.0: (164, 255, 0, 255,),
    12000.0: (202, 255, 0, 255,), 13000.0: (246, 255, 0, 255,), 14000.0: (255, 233, 0, 255,),
    15000.0: (255, 190, 0, 255,), 16000.0: (255, 160, 0, 255,), 17000.0: (255, 119, 0, 255,),
    18000.0: (255, 84, 0, 255,), 19000.0: (255, 51, 0, 255,), 20000.0: (255, 11, 0, 255,),
...
def color_mapping(data):
    ...
    m = data.shape[0]
    data00[70:(70 + m), :] = data
    nanId = np.where((data00 >= 20000) | (data00 == 0) | np.isnan(data00))
    data = data00
