...
for i=1:floor(max_eia)
 ...
 for i = 1:floor(max_eia)+1
 eval(['Train' num2str(i) '=' '[' 'ones(1001*length(1:2:long' '(' num2str(i) ')' ')' ',' '1),'... 
        'reshape' '(' 'tb1v(:,sita' num2str(i) '(1:2:long' '(' num2str(i) ')' ')),' '1001*' 'length' '(1:2:long' '(' num2str(i) ')' '),1)' ',' 'reshape' '(tb1h(:,sita' num2str(i) '(1:2:long' '(' num2str(i) '))),1001*' 'length' '(1:2:long(' num2str(i) ')),1),'...
        'reshape' '(' 'tb2v(:,sita' num2str(i) '(1:2:long' '(' num2str(i) ')' ')),' '1001*' 'length' '(1:2:long' '(' num2str(i) ')' '),1)' ',' 'reshape' '(tb2h(:,sita' num2str(i) '(1:2:long' '(' num2str(i) '))),1001*' 'length' '(1:2:long(' num2str(i) ')),1),' ...
        'reshape' '(' '-log(290-tb3v(:,sita' num2str(i) '(1:2:long(' num2str(i) ')))),1001*length(1:2:long(' num2str(i) ')),1),' 'reshape' '(-log(290-tb3h(:,sita' num2str(i) '(1:2:long(' num2str(i) ')))),1001*length(1:2:long(' num2str(i) ')),1),'...
        'reshape' '(' '-log(290-tb4v(:,sita' num2str(i) '(1:2:long(' num2str(i) ')))),1001*length(1:2:long(' num2str(i) ')),1),' 'reshape' '(-log(290-tb4h(:,sita' num2str(i) '(1:2:long(' num2str(i) ')))),1001*length(1:2:long(' num2str(i) ')),1),'...
        'reshape' '(' '-log(290-tb5v(:,sita' num2str(i) '(1:2:long(' num2str(i) ')))),1001*length(1:2:long(' num2str(i) ')),1),' 'reshape' '(-log(290-tb5h(:,sita' num2str(i) '(1:2:long(' num2str(i) ')))),1001*length(1:2:long(' num2str(i) ')),1)' '];' ] );
 
 eval(['Train_SST' num2str(i) '=' 'reshape' '(sst(:,sita' num2str(i) '(1:2:long(' num2str(i) '))),1001*' 'length' '(1:2:long(' num2str(i) ')),1);']);
 end
...
%% 划分测试集
for i = 1:floor(max_eia)+1
 eval(['Test' num2str(i) '=' '[' 'ones(1001*length(2:2:long' '(' num2str(i) ')' ')' ',' '1),'... 
        'reshape' '(' 'tb1v(:,sita' num2str(i) '(2:2:long' '(' num2str(i) ')' ')),' '1001*' 'length' '(2:2:long' '(' num2str(i) ')' '),1)' ',' 'reshape' '(tb1h(:,sita' num2str(i) '(2:2:long' '(' num2str(i) '))),1001*' 'length' '(2:2:long(' num2str(i) ')),1),'...
        'reshape' '(' 'tb2v(:,sita' num2str(i) '(2:2:long' '(' num2str(i) ')' ')),' '1001*' 'length' '(2:2:long' '(' num2str(i) ')' '),1)' ',' 'reshape' '(tb2h(:,sita' num2str(i) '(2:2:long' '(' num2str(i) '))),1001*' 'length' '(2:2:long(' num2str(i) ')),1),' ...
        'reshape' '(' '-log(290-tb3v(:,sita' num2str(i) '(2:2:long(' num2str(i) ')))),1001*length(2:2:long(' num2str(i) ')),1),' 'reshape' '(-log(290-tb3h(:,sita' num2str(i) '(2:2:long(' num2str(i) ')))),1001*length(2:2:long(' num2str(i) ')),1),'...
        'reshape' '(' '-log(290-tb4v(:,sita' num2str(i) '(2:2:long(' num2str(i) ')))),1001*length(2:2:long(' num2str(i) ')),1),' 'reshape' '(-log(290-tb4h(:,sita' num2str(i) '(2:2:long(' num2str(i) ')))),1001*length(2:2:long(' num2str(i) ')),1),'...
        'reshape' '(' '-log(290-tb5v(:,sita' num2str(i) '(2:2:long(' num2str(i) ')))),1001*length(2:2:long(' num2str(i) ')),1),' 'reshape' '(-log(290-tb5h(:,sita' num2str(i) '(2:2:long(' num2str(i) ')))),1001*length(2:2:long(' num2str(i) ')),1)' '];' ] );
 
 eval(['Test_SST' num2str(i) '=' 'reshape' '(sst(:,sita' num2str(i) '(2:2:long(' num2str(i) '))),1001*' 'length' '(2:2:long(' num2str(i) ')),1);']);
end
...
%% 还原图形
for i=1:floor(max_eia)+1
    eval(['Train_SST_R_R' num2str(i) '=' 'reshape' '(Train_SST_R' num2str(i) ',1001,' 'length(Train_SST_R' num2str(i) ')' './' '1001' ');']);
    eval(['Test_SST_R_R' num2str(i) '=' 'reshape' '(Test_SST_R' num2str(i) ',1001,' 'length(Test_SST_R' num2str(i) ')' './' '1001' ');']);
end
...
xy=[145,155,30,40];
axis(xy);
xlabel('经度','fontsize',14,'fontweight','bold','color','k');
ylabel('纬度','fontsize',14,'fontweight','bold','color','k');
title({'海面温度真值'},'fontsize',14,'fontweight','bold','color','k');
